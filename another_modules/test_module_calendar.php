...
$myCal = new MyCalendar(2021 , 10 ,20 , $pdo);
$myCal->getRowsFromDB();
    ...
    <div id="module-calendar-cal-body">
        ...
        <div id="module-calendar-numbers">
            ...
            foreach ($myCal->rowsIteratorManager() as $row) {
                ...
                foreach ($row as $item) {
                    echo "<div class='day-name date ";
                    if($myCal->fetcher($item[0])) echo 'fill ';
                    echo "{$item[1]}'><span>$item[0]</span></div>";
                }
                echo "</div>";
            }
...
<style>
    ...
    div#module-calendar div.day-name {
        /* border: 1px solid black; */
        /* width: 36px; */
        flex-basis: 36px;
        flex-grow: 0;
    ...
    div#module-calendar div.day-name.name {
        color: #5b5b5b;
    }

    div#module-calendar div.day-name.date {
        color: #d4d4d4;
    }
...
<script>
    ...
    class myCalendar {
        ...
        getDatesOfContentByDate (month = 9 , year = 2021) {
        ...
        rendCalenar (month, year ,data) {
            ...
            let aDayBlock = document.createElement('div');
