function poetry_button(){
    //
    let bodySelector = document.querySelector('body');
    let diaryButton = document.querySelector('span[id="theme-item-13"] > a');
    ...
    diaryButton.addEventListener('click' , function(clickEvent){
        ...
        xhr.open('POST' , 'my_profile_php_handlers/my_profile_poetry_handler.php');
