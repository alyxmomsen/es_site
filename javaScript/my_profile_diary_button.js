function diary_button(){
    let bodySelector = document.querySelector('body');
    let diaryButton = document.querySelector('span[id="theme-item-3"] > a');
    ...
    diaryButton.addEventListener('click' , function(clickEvent){
        ...
        xhr.open('POST' , 'my_profile_php_handlers/my_profile_my_diary_handler.php');
