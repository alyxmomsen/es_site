function music_button(){
    ...
    let diaryButton = document.querySelector('span[id="theme-item-7"] > a');
    ...
    diaryButton.addEventListener('click' , function(clickEvent){
        ...
        xhr.open('POST' , 'my_profile_php_handlers/my_profile_music_handler.php');
        ...
        closeButtonSelector.addEventListener('click' , function(){
            ...
            bodySelector.style.overflowY = 'scroll';
        });
